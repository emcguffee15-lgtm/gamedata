...
ApiKey = ""
Serverkey = "Basic NlVSdVRTbERLS2ZZYnVEVzo="
nichepeople = ["skibb.ok", "exploding_car"]
app: Flask = Flask(__name__)
# app.config['SECRET_KEY'] = 'lguMZY7kBEi0LMSDvuVRzg=='
#sockets = Sockets(app)
sockets = Sockets(app)
            ...
            "joins": [
                {
                    ...
                    "username": "OWNER: FLANK",
                    "status": "{\"roomCode\":\"67\",\"gameMode\":0,\"appearOffline\":false,\"clientVersion\":\"1.38.0.1672\",\"photonVersion\":\"UkqqufU7dTP1FgbMqS39\"}"
                }
           ]
       }
    }})
dihhcord = "https://discord.com/api/webhooks/1480329326816923689/kUiYtBMhyo2iqe2NG--ZHUu0XTgOc39ErgV1vqgHeGVOdU0mgMYObk_g4TNIRppYnZ0z"
  ...
  "friends": [
    {
      "user": {
        "id": "8c1acc32f2454fb9a9a76fb6dfbf572f",
        "username": "<color=red>OWNER</color>: FLANK",
        "display_name": "<color=red>OWNER</color>: FLANK",
        "lang_tag": "en",
...
#                "display_name": "unitygame",
    ...
    elif username == "massive.dude.vr":
        return jsonify({
            "user": {
                "id": uuid.uuid4().hex,
                "username": "<size=5><color=green>massive</color></size>",
                "display_name": "<size=5><color=green>massive</color></size>",
                "lang_tag": "en",
                "metadata": {"isDeveloper": True},
                "edge_count": 240,
                "create_time": "2024-08-24T04:20:56Z",
...
def nakamacloudccaaCaveDatabootstrap():
    payload = {
        ...
        "photonAppID": "9f0c5743-d8b4-4bf8-a8e5-b4545574a476",
        ...
        "gameDataURL": "https://gamedata-git-main-emcguffee15-lgtms-projects.vercel.app/RAM%20Update%201.27.0.zip"
    }
